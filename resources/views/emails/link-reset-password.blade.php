        ...
        <td class="container">
          <div class="content">
                ...
                <td class="wrapper">
                  <table role="presentation" border="0" cellpadding="0" cellspacing="0">
                    <div style="text-align: center;">
                        <img src="img/logoRegister.jpeg" alt="" style="width: 300px;">
                    </div>
                    <tr>
                      <td>
                        <p>Hola asegurado,</p>
                            ...
                            <tr>
                              <td align="center">
                                <table role="presentation" border="0" cellpadding="0" cellspacing="0">
                                  <tbody>
                                    <tr>
                                      <td> <a href="http://127.0.0.1:8000/new-password" target="_blank" style="background-color: #4a38a7; border: #fff;">Reset Password</a> </td>
                                    </tr>
                                  </tbody>
                                </table>
                              </td>
            ...
            <div class="footer">
              <table role="presentation" border="0" cellpadding="0" cellspacing="0">
                <tr>
                  <td class="content-block" style="font-weight: bold;">
                    <span class="apple-link">Copyright © In-Seguros CDITI 2022.</span>
